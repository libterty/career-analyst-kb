...
| 重跑 `latency_bench.py`（目標 P50 ≤ 8s，M3 Max 本機） | ✅ Done — **P50 73s / P95 111s**（concurrency=3，目標修訂：serial P50 待補）⚠️ 目標 8s 為 API 模型基準，本機 30B MoE 需另訂 | `eval/results/latency_bench_20260428_210653.json` |
